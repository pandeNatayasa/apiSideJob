...
Route::group([
    ...
    // Route::resource('jasa','TbPekerjaanController');
    Route::get('showDataJasa/{id}','TbPekerjaanController@show');
    Route::get('showDataJasaUser/{id}','TbPekerjaanController@showDataJasaUser');
    Route::get('showDataJasaForAdmin/{id}','TbPekerjaanController@showDataJasaforAdmin');

    Route::post('store_data_jasa','TbPekerjaanController@store');
    ...
    Route::get('delete_data_jasa/{id}','TbPekerjaanController@edit'); 

    Route::delete('delete_favorite/{id}','TbFavoriteController@destroy'); 

    Route::get('update_status/{id}','TbPekerjaanController@update');
